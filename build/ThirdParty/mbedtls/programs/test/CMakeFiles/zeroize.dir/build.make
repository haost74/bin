...
ThirdParty/mbedtls/programs/test/CMakeFiles/zeroize.dir/zeroize.c.o: ../ThirdParty/mbedtls/programs/test/zeroize.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir="/home/haost/Рабочий стол/ipBinance/binance-cxx-api/assembly/build/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_1) "Building C object ThirdParty/mbedtls/programs/test/CMakeFiles/zeroize.dir/zeroize.c.o"
	cd "/home/haost/Рабочий стол/ipBinance/binance-cxx-api/assembly/build/ThirdParty/mbedtls/programs/test" && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/zeroize.dir/zeroize.c.o -c "/home/haost/Рабочий стол/ipBinance/binance-cxx-api/assembly/ThirdParty/mbedtls/programs/test/zeroize.c"
...
ThirdParty/mbedtls/programs/test/CMakeFiles/zeroize.dir/zeroize.c.i: cmake_force
	...
	cd "/home/haost/Рабочий стол/ipBinance/binance-cxx-api/assembly/build/ThirdParty/mbedtls/programs/test" && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E "/home/haost/Рабочий стол/ipBinance/binance-cxx-api/assembly/ThirdParty/mbedtls/programs/test/zeroize.c" > CMakeFiles/zeroize.dir/zeroize.c.i
...
ThirdParty/mbedtls/programs/test/CMakeFiles/zeroize.dir/zeroize.c.s: cmake_force
	...
	cd "/home/haost/Рабочий стол/ipBinance/binance-cxx-api/assembly/build/ThirdParty/mbedtls/programs/test" && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S "/home/haost/Рабочий стол/ipBinance/binance-cxx-api/assembly/ThirdParty/mbedtls/programs/test/zeroize.c" -o CMakeFiles/zeroize.dir/zeroize.c.s
...
ThirdParty/mbedtls/programs/test/zeroize: ThirdParty/mbedtls/programs/test/CMakeFiles/zeroize.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="/home/haost/Рабочий стол/ipBinance/binance-cxx-api/assembly/build/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable zeroize"
	cd "/home/haost/Рабочий стол/ipBinance/binance-cxx-api/assembly/build/ThirdParty/mbedtls/programs/test" && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/zeroize.dir/link.txt --verbose=$(VERBOSE)
...
ThirdParty/mbedtls/programs/test/CMakeFiles/zeroize.dir/clean:
	cd "/home/haost/Рабочий стол/ipBinance/binance-cxx-api/assembly/build/ThirdParty/mbedtls/programs/test" && $(CMAKE_COMMAND) -P CMakeFiles/zeroize.dir/cmake_clean.cmake
